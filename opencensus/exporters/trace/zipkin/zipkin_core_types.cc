...
int _kAnnotationTypeValues[] = {AnnotationType::BOOL,  AnnotationType::BYTES,
                                AnnotationType::I16,   AnnotationType::I32,
                                AnnotationType::I64,   AnnotationType::DOUBLE,
                                AnnotationType::STRING};
const char* _kAnnotationTypeNames[] = {"BOOL", "BYTES",  "I16",   "I32",
                                       "I64",  "DOUBLE", "STRING"};
const std::map<int, const char*> _AnnotationType_VALUES_TO_NAMES(
    ::apache::thrift::TEnumIterator(7, _kAnnotationTypeValues,
                                    _kAnnotationTypeNames),
    ::apache::thrift::TEnumIterator(-1, NULL, NULL));

std::ostream& operator<<(std::ostream& out, const AnnotationType::type& val) {
  std::map<int, const char*>::const_iterator it =
      _AnnotationType_VALUES_TO_NAMES.find(val);
...
void Endpoint::__set_ipv4(const int32_t val) { this->ipv4 = val; }

void Endpoint::__set_port(const int16_t val) { this->port = val; }
...
uint32_t Endpoint::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("service_name",
  ...
  if (this->__isset.ipv6) {
    xfer +=
        oprot->writeFieldBegin("ipv6", ::apache::thrift::protocol::T_STRING, 4);
...
void Endpoint::printTo(std::ostream& out) const {
  ...
  out << ", "
      << "ipv6=";
  (__isset.ipv6 ? (out << to_string(ipv6)) : (out << "<null>"));
  out << ")";
}

Annotation::~Annotation() throw() {}

void Annotation::__set_timestamp(const int64_t val) { this->timestamp = val; }

void Annotation::__set_value(const std::string& val) { this->value = val; }
...
uint32_t Annotation::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer +=
      oprot->writeFieldBegin("timestamp", ::apache::thrift::protocol::T_I64, 1);
  xfer += oprot->writeI64(this->timestamp);
  xfer += oprot->writeFieldEnd();

  xfer +=
      oprot->writeFieldBegin("value", ::apache::thrift::protocol::T_STRING, 2);
  xfer += oprot->writeString(this->value);
  xfer += oprot->writeFieldEnd();

  if (this->__isset.host) {
    xfer +=
        oprot->writeFieldBegin("host", ::apache::thrift::protocol::T_STRUCT, 3);
...
void BinaryAnnotation::__set_key(const std::string& val) { this->key = val; }
...
uint32_t BinaryAnnotation::write(
  ...
  xfer += oprot->writeFieldBegin("annotation_type",
  ...
  if (this->__isset.host) {
    xfer +=
        oprot->writeFieldBegin("host", ::apache::thrift::protocol::T_STRUCT, 4);
    xfer += this->host.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  xfer += oprot->writeFieldStop();
...
void BinaryAnnotation::printTo(std::ostream& out) const {
  ...
  out << ", "
      << "value=" << to_string(value);
  out << ", "
      << "annotation_type=" << to_string(annotation_type);
  out << ", "
      << "host=";
  (__isset.host ? (out << to_string(host)) : (out << "<null>"));
  out << ")";
...
void Span::__set_trace_id(const int64_t val) { this->trace_id = val; }

void Span::__set_name(const std::string& val) { this->name = val; }

void Span::__set_id(const int64_t val) { this->id = val; }
...
uint32_t Span::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer +=
      oprot->writeFieldBegin("trace_id", ::apache::thrift::protocol::T_I64, 1);
  xfer += oprot->writeI64(this->trace_id);
  xfer += oprot->writeFieldEnd();

  xfer +=
      oprot->writeFieldBegin("name", ::apache::thrift::protocol::T_STRING, 3);
  ...
  xfer += oprot->writeFieldBegin("binary_annotations",
                                 ::apache::thrift::protocol::T_LIST, 8);
  {
    xfer += oprot->writeListBegin(
        ::apache::thrift::protocol::T_STRUCT,
        static_cast<uint32_t>(this->binary_annotations.size()));
    std::vector<BinaryAnnotation>::const_iterator _iter18;
    for (_iter18 = this->binary_annotations.begin();
         _iter18 != this->binary_annotations.end(); ++_iter18) {
  ...
  if (this->__isset.debug) {
    xfer +=
        oprot->writeFieldBegin("debug", ::apache::thrift::protocol::T_BOOL, 9);
...
void Span::printTo(std::ostream& out) const {
  ...
  out << ", "
      << "parent_id=";
  (__isset.parent_id ? (out << to_string(parent_id)) : (out << "<null>"));
  out << ", "
      << "annotations=" << to_string(annotations);
  out << ", "
      << "binary_annotations=" << to_string(binary_annotations);
  out << ", "
      << "debug=";
  (__isset.debug ? (out << to_string(debug)) : (out << "<null>"));
  out << ", "
      << "timestamp=";
  (__isset.timestamp ? (out << to_string(timestamp)) : (out << "<null>"));
  out << ", "
      << "duration=";
  (__isset.duration ? (out << to_string(duration)) : (out << "<null>"));
  out << ", "
      << "trace_id_high=";
  (__isset.trace_id_high ? (out << to_string(trace_id_high))
                         : (out << "<null>"));
  out << ")";
}
