 ...
 *  @generated
 */
#ifndef zipkin_core_TYPES_H
#define zipkin_core_TYPES_H
...
typedef struct _Endpoint__isset {
  _Endpoint__isset()
      : ipv4(false), port(false), service_name(false), ipv6(false) {}
  bool ipv4 : 1;
  bool port : 1;
  bool service_name : 1;
  bool ipv6 : 1;
...
class Endpoint : public virtual ::apache::thrift::TBase {
 public:
  ...
  bool operator==(const Endpoint& rhs) const {
    ...
    if (!(service_name == rhs.service_name)) return false;
...
class Annotation : public virtual ::apache::thrift::TBase {
 public:
  ...
  bool operator!=(const Annotation& rhs) const { return !(*this == rhs); }
...
typedef struct _BinaryAnnotation__isset {
  _BinaryAnnotation__isset()
      : key(false), value(false), annotation_type(false), host(false) {}
  bool key : 1;
  bool value : 1;
...
class BinaryAnnotation : public virtual ::apache::thrift::TBase {
 public:
  ...
  BinaryAnnotation()
      : key(), value(), annotation_type((AnnotationType::type)0) {}
  ...
  bool operator==(const BinaryAnnotation& rhs) const {
    ...
    if (!(value == rhs.value)) return false;
    if (!(annotation_type == rhs.annotation_type)) return false;
    if (__isset.host != rhs.__isset.host)
      return false;
    else if (__isset.host && !(host == rhs.host))
      return false;
  ...
  bool operator!=(const BinaryAnnotation& rhs) const { return !(*this == rhs); }
...
class Span : public virtual ::apache::thrift::TBase {
 public:
  ...
  bool operator==(const Span& rhs) const {
    if (!(trace_id == rhs.trace_id)) return false;
    ...
    if (!(binary_annotations == rhs.binary_annotations)) return false;
